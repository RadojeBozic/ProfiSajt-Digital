        ...
        <TabGroup :selectedIndex="selectedTab" @change="changeTab">
          ...
          <div class="flex justify-center">
            <TabList
              ...
              <Tab as="template">
                <button
                  class="flex-1 flex items-center gap-2.5 text-sm font-medium h-8 px-3 rounded-lg whitespace-nowrap focus-visible:outline-hidden ui-focus-visible:outline-none ui-focus-visible:ring ui-focus-visible:ring-blue-300 transition-colors"
          ...
          <TabPanels class="relative flex items-center justify-center h-[324px]">
            ...
            <div
              class="absolute -z-10 inset-x-[200px] top-1/2 h-px bg-linear-to-r from-transparent via-blue-500/60 to-transparent mix-blend-multiply">
            </div>
            <div
            ...
            <!-- Diagonal lines -->
            <div
              class="absolute -z-10 inset-x-[300px] top-1/2 h-px bg-linear-to-r from-transparent via-gray-200 to-transparent rotate-[20deg] mix-blend-multiply">
            </div>
            <div
              class="absolute -z-10 inset-x-[300px] top-1/2 h-px bg-linear-to-r from-transparent via-gray-200 to-transparent -rotate-[20deg] mix-blend-multiply">
            </div>
            <!-- Vertical lines -->
            <div
              class="absolute -z-10 inset-y-0 left-1/2 w-px bg-linear-to-b from-gray-200 to-transparent -translate-x-[216px] mix-blend-multiply">
            </div>
            <div
              class="absolute -z-10 inset-y-0 left-1/2 w-px bg-linear-to-t from-gray-200 to-transparent translate-x-[216px] mix-blend-multiply">
            </div>
            <!-- Logos -->
            <div
            ...
            <TabPanel
              :static="true"
              class="focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-indigo-300"
