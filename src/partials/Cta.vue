    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div
        ...
        <div class="absolute left-1/2 transform -translate-x-1/2 top-0 pointer-events-none -z-10" aria-hidden="true">
          <img class="max-w-none" src="../images/stripes-dark.svg" width="768" height="432" :alt="t('cta.stripesAlt')" />
        </div>
          ...
          <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
            ...
            >
              <span class="relative inline-flex items-center">
                {{ t('cta.primary') }}
                <span class="tracking-normal text-blue-300 group-hover:translate-x-0.5 transition-transform ml-1">-&gt;</span>
              </span>
            </RouterLink>
          </div>
          <p class="text-gray-300 text-sm mt-4 max-w-md mx-auto px-4">
            {{ t('cta.subtext') }}
          </p>
        </div>
