  ...
  <section class="relative">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="max-w-3xl mx-auto pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div>
          <button
            class="w-full bg-white/70 text-gray-400 text-sm inline-flex items-center justify-between pl-4 pr-3 py-3.5 shadow-sm shadow-black/[0.03] rounded-lg relative before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(var(--color-gray-100),var(--color-gray-200))_border-box] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] before:[mask-composite:exclude_!important] before:pointer-events-none whitespace-nowrap"
            :aria-label="t('supportHero.searchButton.aria')"
          ...
          >
            <div class="flex items-center justify-center">
              ...
              <span>
                {{ t('supportHero.searchButton.label') }}
                <span class="hidden sm:inline">
                  {{ t('supportHero.searchButton.placeholder') }}
                </span>
                …
              </span>
            </div>

            <!-- Keyboard hints (ikonice ostaju iste) -->
            <div class="ml-3 flex gap-1">
              <div class="flex items-center justify-center h-6 w-6 bg-white text-gray-400 rounded-sm shadow-xs">
